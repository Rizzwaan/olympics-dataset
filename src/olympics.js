...
export const noOfOlympicsHostedPerNoc = (athleteData) => {
  ...
  const hostingByEachCity = Object.keys(noOFOlymopicEachHosted)
    .reduce((city, hostCity) => {
...
export const topTenCountriesWonMedalAfter2000 = (athleteData, nocData) => {
...
export const perYearAverageAgeOfAthlete = (athleteData) => {
...
const removeNan = athleteData => athleteData.filter(value => !isNaN(value.Age));

// console.log(perYearAverageAgeOfAthlete(athleteData));
...
export const allMedalWinnersFromIndiaPerSeason = (athleteData) => {
...
// Helper
const countryWiseFilter = (athleteData, NOC) => athleteData.filter(data => data.NOC === NOC && data.Medal !== 'NA');
// console.log(allMedalWinnersFromIndiaPerSeason(athleteData));

// ------------------fifth function ends here-----------------------//

// /-------------------Third Function starts here ------------------------///

export const maleAndFemaleParticipationForDecades = (athleteData) => {
  ...
  const maleAndFemaleInDecadeInAscendingOrder = sortAscendingDecade(maleAndFemaleInDecade);
  // return maleAndFemaleInDecade
